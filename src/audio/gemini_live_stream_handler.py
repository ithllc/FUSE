                ...
                parts=[
                    types.Part.from_text(
                        text=(
                            ...
                            "When a session starts, you will receive a diagnostic prompt. "
                            "Follow its instructions exactly to help verify the user's microphone. "
                            "Keep diagnostic responses to two sentences maximum. "
                            "After diagnostics, proceed normally as a brainstorming facilitator. "
